...
export const ENDPOINTS = {
  ...
  AUTH: {
    ...
    VERIFY_EMAIL_VALIDATE: `/api/${API_VERSION}/auth/verify-email/validate`,
    VERIFY_EMAIL_CONFIRM: `/api/${API_VERSION}/auth/verify-email/confirm`,
    RESEND_VERIFICATION: `/api/${API_VERSION}/auth/resend-verification`,
    VERIFY_EMAIL_NOT_ME: `/api/${API_VERSION}/auth/verify-email/not-me`,
